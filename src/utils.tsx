...
export function normalMemSlotId(displayId: string, frame: number): string {
  ...
  if (stackSlotId) {
    return _normalMemSlotId(stackSlotId, stackSlotId.offset, frame);
  }
  return displayId;
}

export function getAdjustedMemSlotId(
  bpfState: BpfState,
  ...
  return _normalMemSlotId(stackSlotId, totalOffset, bpfState.frame);
}
